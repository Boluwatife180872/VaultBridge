...
const Footer = () => {
  ...
  return (
    <section className="bg-linear-to-r from-[#102B42] to-black mt-14 text-white">
      <div className="max-w-[1100px] mx-auto px-4 sm:px-6 py-12 md:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          <div>
            ...
            <h4 className="text-[#4CAFA7] text-sm">FOLLOW US</h4>
            <div className="flex gap-4 mt-3">
              <FaTwitter
                size={20}
                className="hover:text-[#4CAFA7] duration-300 cursor-pointer"
              />
              <FaLinkedinIn
                size={20}
                className="hover:text-[#4CAFA7] duration-300 cursor-pointer"
          ...
          <div className="md:col-span-3 grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-10">
            <div>
              <h2 className="text-[#4CAFA7] text-sm">COMPANY</h2>
              <div className="flex flex-col gap-2 md:gap-3 mt-4 md:mt-6 text-sm">
                <button
                  onClick={() => scrollTo("hero")}
                  className="text-left hover:text-[#4CAFA7] duration-300 cursor-pointer"
                >
                  About Us
                </button>
                <button
            ...
            <div>
              <h2 className="text-[#4CAFA7] text-sm">PRODUCT</h2>
              <div className="flex flex-col gap-2 md:gap-3 mt-4 md:mt-6 text-sm">
                <button
            ...
            <div className="col-span-2 md:col-span-1">
              <h2 className="text-[#4CAFA7] text-sm">RESOURCES</h2>
              <div className="flex flex-col gap-2 md:gap-3 mt-4 md:mt-6 text-sm">
                <button
