      ...
      <div className="max-w-[1100px] mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16 my-16">
          <div className="flex justify-center md:justify-start">
            <div className="relative w-[280px] sm:w-[310px] md:w-[360px] group">
              <div
                ...
                after:bg-brand-bg-2 after:rounded-xl after:opacity-0
          ...
          <div className="text-left px-2 sm:px-4 lg:px-0">
            <h2 className="text-brand-dark text-xl sm:text-2xl md:text-3xl font-semibold">
              Save, Spend, Get a loan
            </h2>

            <p className="my-5 text-brand-muted text-sm sm:text-base md:text-lg leading-relaxed max-w-[550px]">
            ...
            <div className="flex flex-wrap items-center gap-6 text-brand-muted mt-6">
              <div>
              ...
              <div className="w-px h-10 bg-brand-muted"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16 my-16 px-4 sm:px-6 lg:px-0">
          <div className="flex items-center">
            <div>
              ...
              <div className="flex items-center gap-6 text-brand-muted mt-6">
                <button
                  onClick={() => scrollTo("products")}
                  className="px-3 py-2 border-2 border-brand-gold rounded-xl hover:border-brand-bg-2 transition-colors duration-300 cursor-pointer"
                >
                  Get Started
                </button>
              </div>
