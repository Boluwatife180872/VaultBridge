...
const TopBar = () => {
  ...
  return (
    <div className="bg-brand-dark relative overflow-hidden">
      <div className="absolute inset-0 bg-linear-to-r from-brand-gold/10 to-transparent" />
      <div className="relative flex flex-col md:flex-row items-center justify-center text-white px-4 py-3 md:py-3 max-w-[1200px] mx-auto gap-2 w-full">
        <p className="text-sm md:text-sm text-center md:text-left">
          ...
          <button onClick={() => scrollTo("products")} className="underline underline-offset-2 hover:text-brand-gold transition-colors cursor-pointer font-medium">
            Learn more
          </button>
        </p>
      </div>
